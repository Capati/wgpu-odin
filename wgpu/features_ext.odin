...
MAX_FEATURES :: FeatureNameBits.Max
...
*/
Features :: bit_set[FeatureNameBits;u64]
...
features_all_native_flags :: proc "contextless" (features: Features) -> (ret: Features) {
	for f in features {
		...
		case .RayTracingAccelerationStructure:
			ret += {.RayTracingAccelerationStructure}
		case .RayQuery:
			ret += {.RayQuery}
		case .ShaderF64:
			ret += {.ShaderF64}
