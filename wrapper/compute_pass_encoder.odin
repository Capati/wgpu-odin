...
compute_pass_encoder_dispatch_workgroups :: proc "contextless" (
...
compute_pass_encoder_dispatch_workgroups_indirect :: proc "contextless" (
	using self: Compute_Pass_Encoder,
...
compute_pass_encoder_end :: proc "contextless" (
	using self: Compute_Pass_Encoder,
	loc := #caller_location,
) -> (
	err: Error,
...
compute_pass_encoder_insert_debug_marker :: proc "contextless" (
	using self: Compute_Pass_Encoder,
...
compute_pass_encoder_pop_debug_group :: proc "contextless" (using self: Compute_Pass_Encoder) {
	wgpu.compute_pass_encoder_pop_debug_group(ptr)
}

// Start record commands and group it into debug marker group.
compute_pass_encoder_push_debug_group :: proc "contextless" (
	using self: Compute_Pass_Encoder,
	group_label: cstring,
) {
...
compute_pass_encoder_set_bind_group :: proc "contextless" (
	using self: Compute_Pass_Encoder,
	group_index: u32,
...
// Set debug label.
compute_pass_encoder_set_label :: proc "contextless" (
	using self: Compute_Pass_Encoder,
	label: cstring,
) {
...
compute_pass_encoder_set_pipeline :: proc "contextless" (
	using self: Compute_Pass_Encoder,
...
compute_pass_encoder_begin_pipeline_statistics_query :: proc "contextless" (
	using self: Compute_Pass_Encoder,
...
compute_pass_encoder_end_pipeline_statistics_query :: proc "contextless" (
	using self: Compute_Pass_Encoder,
) {
...
compute_pass_encoder_reference :: proc "contextless" (using self: Compute_Pass_Encoder) {
	wgpu.compute_pass_encoder_reference(ptr)
}

// Release the `Compute_Pass_Encoder`.
compute_pass_encoder_release :: #force_inline proc "contextless" (
	using self: Compute_Pass_Encoder,
) {
...
compute_pass_encoder_release_and_nil :: proc "contextless" (using self: ^Compute_Pass_Encoder) {
